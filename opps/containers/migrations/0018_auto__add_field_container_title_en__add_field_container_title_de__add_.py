...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'containers_container', 'title_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.title_de'
        db.add_column(u'containers_container', 'title_de',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.title_ru'
        db.add_column(u'containers_container', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.hat_en'
        db.add_column(u'containers_container', 'hat_en',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.hat_de'
        db.add_column(u'containers_container', 'hat_de',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Container.hat_ru'
        db.add_column(u'containers_container', 'hat_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'containers_container', 'title_en')

        # Deleting field 'Container.title_de'
        db.delete_column(u'containers_container', 'title_de')

        # Deleting field 'Container.title_ru'
        db.delete_column(u'containers_container', 'title_ru')

        # Deleting field 'Container.hat_en'
        db.delete_column(u'containers_container', 'hat_en')

        # Deleting field 'Container.hat_de'
        db.delete_column(u'containers_container', 'hat_de')

        # Deleting field 'Container.hat_ru'
        db.delete_column(u'containers_container', 'hat_ru')
